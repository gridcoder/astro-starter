  ...
  const sections = [
    {
      ...
      items: [
        { title: "Active transparency", id: "active-transparency" },
        { title: "Be heard", id: "be-heard" },
        { title: "The composition of ministries", id: "the-compositions-of-the-ministries" }
      ]
    },
    {
      title: "Parliament",
      id: "parliament-section",
      items: [
        { title: "Real debates in Parliament", id: "real-debates-in-parliament" },
        { title: "Active Transparency (Parliament edition)", id: "active-transparency-parliament-edition" },
        { title: "The President of Parliament", id: "the-president-of-parliament" }
      ]
    },
    {
      title: "Elections",
      ...
      items: [
        { title: "Separate elections", id: "separate-elections" },
        { title: "How your vote is counted", id: "how-your-vote-is-counted" },
        {
          title: "Give our students abroad the right to vote",
          id: "give-our-students-abroad-the-right-to-vote"
        },
        { title: "Campaign financing", id: "campaign-financing" },
        { title: "Transparency in political advertising", id: "transparency-in-political-advertising" }
      ]
    },
    {
      title: "Upholding our Constitution",
      id: "constitution-section",
      items: [{ title: "Constitutional Court", id: "constitutional-court" }]
    },
    {
      title: "State-owned enterprises",
      id: "enterprises-section",
      items: [
        {
          title: "Implementation of good corporate governance",
          id: "implementation-of-good-corporate-governance"
        }
      ]
    }
  ]
...
<div class="relative" bind:this={tocElement}>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    {#each sections as section}
      <div
        class="{getSectionClass(section.id)} p-4 rounded hover:bg-primary/90 transition-colors duration-200"
      >
        <h2 class="text-2xl font-bold font-serif">{section.title}</h2>
        <ul class="space-y-1">
...
{#if isVisible && !isDesktop}
  <div class="relative flex justify-center">
    <div
      class="fixed top-12 lg:top-2 w-full lg:max-w-screen-xs bg-primary text-base-100 shadow-lg z-50 cursor-pointer"
